...
success alert
Good job!
That's correct—the first parameter is the object that we're referring to, but it doesn't have to be called self. That is the convention though, I'd recommend you stick to it!
Question 4:
Would this be valid in Python?
